...
if __name__ == "__main__":
    ...
    # Directories.
    parser.add_argument('--model_save_dir', type=str, default='.\\models\\function')
    ...
    # Train the function model with module Solver
    ...
    # gPINNs model
    # The neural network structure net, the pde loss is NNFunc.
    func_gPINNs = PhysicsInformedNeuralNetwork(net_gpinns, gNNFunc, func, optimizer, w=[1, 1])
    ...
    for training_point in training_points:
        ...
        print("\n#### Start training with training point: {} ####\n".format(training_point))

        # DATA.
        data_f_ab = Data([training_point, 0], [0, 1], 'uniform', 100)
